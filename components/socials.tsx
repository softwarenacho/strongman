    ...
    <section className="bg-strong-blue px-4 py-8 border-4 border-strong-yellow flex flex-col justify-center items-center">
      ...
      <div className="flex justify-around items-center md:max-w-[48rem]">
        {socialNetworks.map(social => (
          <a
            href={social.url}
            className="flex justify-center items-center w-14 h-14 sm:w-24 sm:h-24 md:w-32 md:h-32 mr-2 md:mr-4 last:mr-0 rounded-full hover:bg-strong-blue bg-strong-yellow transition-colors shadow cursor-pointer hover:shadow-xl"
          >
            <img
